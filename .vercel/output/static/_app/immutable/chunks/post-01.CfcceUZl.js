import{s as Vs,j as cn,n as Ps,a as gn,u as _n,g as wn,d as xn,b as js,f as rn}from"./scheduler.DamSiY5E.js";import{S as Hs,i as Ns,e as D,c as i,j as h,b as a,d as e,u as Rs,v as Ys,A as Ss,B as Ms,C as zs,D as Is,s as c,H as W,t as bn,p as Dn,g as d,a as r,E as Q,f as vn,h as Bn,k as An}from"./index.DjKXAdKE.js";import{g as Fn,a as yn}from"./spread.CgU5AtxT.js";function On(C){let l,y;return{c(){l=D("img"),this.h()},l(o){l=i(o,"IMG",{src:!0,alt:!0,loading:!0}),this.h()},h(){cn(l.src,y=C[0])||h(l,"src",y),h(l,"alt",C[1]),h(l,"loading","lazy")},m(o,t){a(o,l,t)},p(o,[t]){t&1&&!cn(l.src,y=o[0])&&h(l,"src",y),t&2&&h(l,"alt",o[1])},i:Ps,o:Ps,d(o){o&&e(l)}}}function Ln(C,l,y){let{src:o}=l,{alt:t}=l;return C.$$set=p=>{"src"in p&&y(0,o=p.src),"alt"in p&&y(1,t=p.alt)},[o,t]}class Cn extends Hs{constructor(l){super(),Ns(this,l,Ln,On,Vs,{src:0,alt:1})}}function kn(C){let l;const y=C[1].default,o=gn(y,C,C[0],null);return{c(){o&&o.c()},l(t){o&&o.l(t)},m(t,p){o&&o.m(t,p),l=!0},p(t,[p]){o&&o.p&&(!l||p&1)&&_n(o,y,t,t[0],l?xn(y,t[0],p,null):wn(t[0]),null)},i(t){l||(Rs(o,t),l=!0)},o(t){Ys(o,t),l=!1},d(t){o&&o.d(t)}}}function Tn(C,l,y){let{$$slots:o={},$$scope:t}=l;return C.$$set=p=>{"$$scope"in p&&y(0,t=p.$$scope)},[t,o]}class Rn extends Hs{constructor(l){super(),Ns(this,l,Tn,kn,Vs,{})}}function Yn(C){let l,y=`Recently I got into CNN based object detectors in computer vision for my master’s thesis and I was wondering whenever I could
work on this project in Rust. Here are my findings on how to load YOLOv4 object detector into a Rust program using OpenCV library.`,o,t,p,u,j="YOLO as Object Detector",J,K,X,E,Us=`For object detection model I went for the popular YOLO detectors. Choosing a particular version might not be as easy as just
...
<span class="line"><span style="color:#569CD6">    let</span><span style="color:#569CD6"> mut</span><span style="color:#9CDCFE"> boxes</span><span style="color:#D4D4D4"> = </span><span style="color:#4EC9B0">core</span><span style="color:#D4D4D4">::</span><span style="color:#4EC9B0">Vector</span><span style="color:#D4D4D4">::&#x3C;</span><span style="color:#4EC9B0">core</span><span style="color:#D4D4D4">::</span><span style="color:#4EC9B0">Rect</span><span style="color:#D4D4D4">>::</span><span style="color:#DCDCAA">new</span><span style="color:#D4D4D4">();    </span></span></code><button class="copy" data-code="    // Vecs to store detections
    ...
    let mut boxes = core::Vector::<core::Rect>::new();    " onclick="
          ...
          this.classList.add(&#x27;copied&#x27;);
          setTimeout(() => this.classList.remove(&#x27;copied&#x27;), 3000)
        "><span class="ready"></span><span class="success"></span></button></pre>`,H,L,an=`Now we are ready to perform detections! Let’s load an image as the input to YOLO the object detector and perform detections.
I’ll take this standard picture of dog as an example.`,vs,k,Bs,N,hn=`<pre class="shiki dark-plus" style="background-color:#1E1E1E;color:#D4D4D4" tabindex="0"><code><span class="line"><span style="color:#6A9955">    // Open img</span></span>
...
&#125;" onclick="
          ...
          this.classList.add(&#x27;copied&#x27;);
          setTimeout(() => this.classList.remove(&#x27;copied&#x27;), 3000)
        "><span class="ready"></span><span class="success"></span></button></pre>`,U,T,$s,R,As,Y,ln=`The weights and configuration that we have used here i.e yolov4-tiny.cfg and it’s default weights, have been trained on MS-COCO
...
is indeed the one it predicts.`,Fs,$,on="Now that model is loaded, true fun can begin and you can build on top of that.",Os,f,tn="Full Code",Ls,P,pn='<a href="https://github.com/bortyr/yolo-rust-tutorial" rel="nofollow">https://github.com/bortyr/yolo-rust-tutorial</a>',ks,q,En=`<pre class="shiki dark-plus" style="background-color:#1E1E1E;color:#D4D4D4" tabindex="0"><code><span class="line"><span style="color:#569CD6">use</span><span style="color:#4EC9B0"> anyhow</span><span style="color:#D4D4D4">::</span><span style="color:#4EC9B0">Result</span><span style="color:#D4D4D4">;</span></span>
<span class="line"><span style="color:#569CD6">use</span><span style="color:#4EC9B0"> itertools</span><span style="color:#D4D4D4">::izip;</span></span>
<span class="line"><span style="color:#569CD6">use</span><span style="color:#4EC9B0"> opencv</span><span style="color:#D4D4D4">::&#123;core, dnn, highgui, imgcodecs, imgproc, </span><span style="color:#4EC9B0">prelude</span><span style="color:#D4D4D4">::*&#125;;</span></span>
<span class="line"></span>
<span class="line"><span style="color:#569CD6">fn</span><span style="color:#DCDCAA"> main</span><span style="color:#D4D4D4">() -> </span><span style="color:#4EC9B0">Result</span><span style="color:#D4D4D4">&#x3C;()> &#123;</span></span>
...
&#125;" onclick="
          ...
          this.classList.add(&#x27;copied&#x27;);
          setTimeout(() => this.classList.remove(&#x27;copied&#x27;), 3000)
        "><span class="ready"></span><span class="success"></span></button></pre>`,G,Ts;return k=new Cn({props:{src:"post-01-img01.jpg",alt:"image_of_dog"}}),R=new Cn({props:{src:"post-01-img02.png",alt:"image_of_dog"}}),{c(){l=D("p"),l.textContent=y,o=c(),t=D("br"),p=c(),u=D("h3"),u.textContent=j,J=c(),K=D("br"),X=c(),E=D("p"),E.textContent=Us,Z=c(),ss=D("br"),ns=c(),g=D("p"),g.innerHTML=qs,es=c(),as=D("br"),ls=c(),_=D("p"),_.textContent=Gs,os=c(),ts=D("br"),ps=c(),w=D("p"),w.textContent=Ws,cs=c(),rs=D("br"),Ds=c(),x=D("ul"),x.innerHTML=Qs,is=c(),m=D("h3"),m.textContent=Js,ys=c(),Cs=D("br"),ds=c(),b=D("p"),b.innerHTML=Ks,us=c(),ms=D("br"),fs=c(),v=D("p"),v.innerHTML=Xs,hs=c(),Es=D("br"),gs=c(),B=D("p"),B.innerHTML=Zs,_s=c(),S=new W(!1),M=c(),A=D("p"),A.textContent=sn,ws=c(),z=new W(!1),I=c(),F=D("p"),F.textContent=nn,xs=c(),O=D("p"),O.textContent=en,bs=c(),V=new W(!1),H=c(),L=D("p"),L.textContent=an,vs=c(),Ss(k.$$.fragment),Bs=c(),N=new W(!1),U=c(),T=D("p"),$s=bn(`This should create a GUI window with the input image and bounding boxes acquired from running the model, drawn on it.
`),Ss(R.$$.fragment),As=c(),Y=D("p"),Y.innerHTML=ln,Fs=c(),$=D("p"),$.textContent=on,Os=c(),f=D("h3"),f.textContent=tn,Ls=c(),P=D("p"),P.innerHTML=pn,ks=c(),q=new W(!1),G=Dn(),this.h()},l(s){l=i(s,"P",{"data-svelte-h":!0}),d(l)!=="svelte-53lfr7"&&(l.textContent=y),o=r(s),t=i(s,"BR",{}),p=r(s),u=i(s,"H3",{id:!0,"data-svelte-h":!0}),d(u)!=="svelte-1cu28tn"&&(u.textContent=j),J=r(s),K=i(s,"BR",{}),X=r(s),E=i(s,"P",{"data-svelte-h":!0}),d(E)!=="svelte-ixwi2w"&&(E.textContent=Us),Z=r(s),ss=i(s,"BR",{}),ns=r(s),g=i(s,"P",{"data-svelte-h":!0}),d(g)!=="svelte-fvaoep"&&(g.innerHTML=qs),es=r(s),as=i(s,"BR",{}),ls=r(s),_=i(s,"P",{"data-svelte-h":!0}),d(_)!=="svelte-lxu8e0"&&(_.textContent=Gs),os=r(s),ts=i(s,"BR",{}),ps=r(s),w=i(s,"P",{"data-svelte-h":!0}),d(w)!=="svelte-wiv8y8"&&(w.textContent=Ws),cs=r(s),rs=i(s,"BR",{}),Ds=r(s),x=i(s,"UL",{"data-svelte-h":!0}),d(x)!=="svelte-hlh6ag"&&(x.innerHTML=Qs),is=r(s),m=i(s,"H3",{id:!0,"data-svelte-h":!0}),d(m)!=="svelte-fbomwj"&&(m.textContent=Js),ys=r(s),Cs=i(s,"BR",{}),ds=r(s),b=i(s,"P",{"data-svelte-h":!0}),d(b)!=="svelte-1hzjf4f"&&(b.innerHTML=Ks),us=r(s),ms=i(s,"BR",{}),fs=r(s),v=i(s,"P",{"data-svelte-h":!0}),d(v)!=="svelte-144gnsw"&&(v.innerHTML=Xs),hs=r(s),Es=i(s,"BR",{}),gs=r(s),B=i(s,"P",{"data-svelte-h":!0}),d(B)!=="svelte-1wqwtgb"&&(B.innerHTML=Zs),_s=r(s),S=Q(s,!1),M=r(s),A=i(s,"P",{"data-svelte-h":!0}),d(A)!=="svelte-1s8yz4m"&&(A.textContent=sn),ws=r(s),z=Q(s,!1),I=r(s),F=i(s,"P",{"data-svelte-h":!0}),d(F)!=="svelte-1tq6337"&&(F.textContent=nn),xs=r(s),O=i(s,"P",{"data-svelte-h":!0}),d(O)!=="svelte-1q1e0rw"&&(O.textContent=en),bs=r(s),V=Q(s,!1),H=r(s),L=i(s,"P",{"data-svelte-h":!0}),d(L)!=="svelte-xkrqye"&&(L.textContent=an),vs=r(s),Ms(k.$$.fragment,s),Bs=r(s),N=Q(s,!1),U=r(s),T=i(s,"P",{});var n=vn(T);$s=Bn(n,`This should create a GUI window with the input image and bounding boxes acquired from running the model, drawn on it.
`),Ms(R.$$.fragment,n),n.forEach(e),As=r(s),Y=i(s,"P",{"data-svelte-h":!0}),d(Y)!=="svelte-v3jdc9"&&(Y.innerHTML=ln),Fs=r(s),$=i(s,"P",{"data-svelte-h":!0}),d($)!=="svelte-u9nvbf"&&($.textContent=on),Os=r(s),f=i(s,"H3",{id:!0,"data-svelte-h":!0}),d(f)!=="svelte-131vqvd"&&(f.textContent=tn),Ls=r(s),P=i(s,"P",{"data-svelte-h":!0}),d(P)!=="svelte-8wufi7"&&(P.innerHTML=pn),ks=r(s),q=Q(s,!1),G=Dn(),this.h()},h(){h(u,"id","yolo-as-object-detector"),h(m,"id","load-yolo"),S.a=M,z.a=I,V.a=H,N.a=U,h(f,"id","full-code"),q.a=G},m(s,n){a(s,l,n),a(s,o,n),a(s,t,n),a(s,p,n),a(s,u,n),a(s,J,n),a(s,K,n),a(s,X,n),a(s,E,n),a(s,Z,n),a(s,ss,n),a(s,ns,n),a(s,g,n),a(s,es,n),a(s,as,n),a(s,ls,n),a(s,_,n),a(s,os,n),a(s,ts,n),a(s,ps,n),a(s,w,n),a(s,cs,n),a(s,rs,n),a(s,Ds,n),a(s,x,n),a(s,is,n),a(s,m,n),a(s,ys,n),a(s,Cs,n),a(s,ds,n),a(s,b,n),a(s,us,n),a(s,ms,n),a(s,fs,n),a(s,v,n),a(s,hs,n),a(s,Es,n),a(s,gs,n),a(s,B,n),a(s,_s,n),S.m(un,s,n),a(s,M,n),a(s,A,n),a(s,ws,n),z.m(mn,s,n),a(s,I,n),a(s,F,n),a(s,xs,n),a(s,O,n),a(s,bs,n),V.m(fn,s,n),a(s,H,n),a(s,L,n),a(s,vs,n),zs(k,s,n),a(s,Bs,n),N.m(hn,s,n),a(s,U,n),a(s,T,n),An(T,$s),zs(R,T,null),a(s,As,n),a(s,Y,n),a(s,Fs,n),a(s,$,n),a(s,Os,n),a(s,f,n),a(s,Ls,n),a(s,P,n),a(s,ks,n),q.m(En,s,n),a(s,G,n),Ts=!0},p:Ps,i(s){Ts||(Rs(k.$$.fragment,s),Rs(R.$$.fragment,s),Ts=!0)},o(s){Ys(k.$$.fragment,s),Ys(R.$$.fragment,s),Ts=!1},d(s){s&&(e(l),e(o),e(t),e(p),e(u),e(J),e(K),e(X),e(E),e(Z),e(ss),e(ns),e(g),e(es),e(as),e(ls),e(_),e(os),e(ts),e(ps),e(w),e(cs),e(rs),e(Ds),e(x),e(is),e(m),e(ys),e(Cs),e(ds),e(b),e(us),e(ms),e(fs),e(v),e(hs),e(Es),e(gs),e(B),e(_s),S.d(),e(M),e(A),e(ws),z.d(),e(I),e(F),e(xs),e(O),e(bs),V.d(),e(H),e(L),e(vs),e(Bs),N.d(),e(U),e(T),e(As),e(Y),e(Fs),e($),e(Os),e(f),e(Ls),e(P),e(ks),e(G),q.d()),Is(k,s),Is(R)}}}function $n(C){let l,y;const o=[C[0],dn];let t={$$slots:{default:[Yn]},$$scope:{ctx:C}};for(let p=0;p<o.length;p+=1)t=js(t,o[p]);return l=new Rn({props:t}),{c(){Ss(l.$$.fragment)},l(p){Ms(l.$$.fragment,p)},m(p,u){zs(l,p,u),y=!0},p(p,[u]){const j=u&1?Fn(o,[u&1&&yn(p[0]),u&0&&yn(dn)]):{};u&2&&(j.$$scope={dirty:u,ctx:p}),l.$set(j)},i(p){y||(Rs(l.$$.fragment,p),y=!0)},o(p){Ys(l.$$.fragment,p),y=!1},d(p){Is(l,p)}}}const dn={title:"YOLOv4 in Rust using OpenCV's Deep Neural Networks",date:"2024-3-30",categories:["Object detection","YOLO","Rust","OpenCV"],published:!0};function Pn(C,l,y){return C.$$set=o=>{y(0,l=js(js({},l),rn(o)))},l=rn(l),[l]}class zn extends Hs{constructor(l){super(),Ns(this,l,Pn,$n,Vs,{})}}export{zn as default,dn as metadata};
